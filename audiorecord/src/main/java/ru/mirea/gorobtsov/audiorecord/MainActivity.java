package ru.mirea.gorobtsov.audiorecord;
...
import ru.mirea.gorobtsov.audiorecord.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isStartRecording) {
                    ...
                    recordButton.setText("Начать запись.4.БСБО-02-20.");
        ...
        playButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isStartPlaying) {
                    playButton.setText("Остаановить воспроизведение");
